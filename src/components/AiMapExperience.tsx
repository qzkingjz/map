...
import { ArrowLeft, Database, Globe2, Layers3, Moon, Quote, Sun } from 'lucide-react';
...
export default function AiMapExperience({ onBack }: AiMapExperienceProps) {
  ...
  return (
    <div className={`app-root theme-${theme} relative h-screen w-screen overflow-hidden font-sans`}>
      ...
      <div className="absolute right-10 top-10 z-[1000] w-[330px] rounded-2xl glass-ui px-4 py-3">
